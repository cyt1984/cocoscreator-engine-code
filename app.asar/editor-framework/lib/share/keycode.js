(function (exports, require, module, __filename, __dirname, process, global, Buffer) {
    return function (exports, require, module, __filename, __dirname) {
        ...
        exports = module.exports = function (r) {
            ...
            let p = String(r),
                a = e[p.toLowerCase()];
            return a || ((a = t[p.toLowerCase()]) || (1 === p.length ? p.charCodeAt(0) : void 0))
        };
        ...
        for (let t = 97; t < 123; t++) e[String.fromCharCode(t)] = t - 32;
        for (let t = 48; t < 58; t++) e[t - 48] = t;
        for (let t = 1; t < 13; t++) e["f" + t] = t + 111;
        for (let t = 0; t < 10; t++) e["numpad " + t] = t + 96;
