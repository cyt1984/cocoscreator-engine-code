    ...
    return function (exports, require, module, __filename, __dirname) {
        ...
        e.watchPackages = function (e) {
            ...
            (x = a.watch(t, {
                ...
                j(a, n.ignore) || (j(a, n.test) ? t.reloadTest = !0 : j(a, n.renderer) ? t.reloadRenderer = !0 : n.main && 0 !== n.main.length && !j(a, n.main) || (t.reloadMain = !0), (t.reloadTest || t.reloadRenderer || t.reloadMain) && (_.push(t), $ && (clearTimeout($), $ = null), $ = setTimeout(() => {
                    (function (e, t) {
                        o.each(e, (e, t) => {
            ...
            let s = t["main-menu"];
            s && (c.register("main-menu", s, !0), v.init());
            ...
            r.existsSync(t + ".js") || (t = "../../static/i18n/en"), k.extend(require(t)), f.reset(), f.register("global", u.home), f.register("local", i.join(u.home, "local")), q.resetPath(), v._resetToBuiltin(), w.templateUrl = "editor-framework://static/window.html", m.defaultLayoutUrl = "app://static/layout.json", y.reset(), b.reset()
        };
